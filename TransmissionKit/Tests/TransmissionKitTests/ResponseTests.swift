...
final class ResponseTests: XCTestCase {
    func testDecode() {
        let responseJSONData = """
            {
              "arguments": {
                ...
                "download-dir-free-space": 12488777728,
        ...
        let decodedResponse = try! JSONDecoder().decode(Response<Session>.self, from: responseJSONData)

        XCTAssertTrue(decodedResponse.arguments.altSpeedDown == 10)
    }
